  ...
  return (
    <section className="py-12 md:py-20">
      <div className="container mx-auto">
        <h2 className="text-center text-3xl font-bold font-display">What clients say about our work</h2>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {items.map((t, i) => (
            <Reveal key={t.name} delay={i * 70} className="rounded-xl border bg-card p-6">
