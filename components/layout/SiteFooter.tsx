        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground max-w-xs">
              Affordable home repair services by certified handymen.
            </p>
          </div>
          <nav className="text-sm">
            ...
            <ul className="mt-3 space-y-2 text-muted-foreground">
              <li>
                <Link href="/services" className="story-link">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/process" className="story-link">
                  Process
                </Link>
              </li>
              <li>
          ...
          <div className="text-sm">
            ...
            <ul className="mt-3 space-y-2 text-muted-foreground">
              <li>
                <Link href="/call-us" className="story-link">
                  Call Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-3 flex gap-3 text-muted-foreground">
              <a
                ...
                className="p-2 rounded-md border hover-scale"
              >
